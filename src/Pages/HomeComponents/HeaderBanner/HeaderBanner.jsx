  ...
  return (
    <div className="max-h-[600px]">
      <div className="relative">
        ...
        <div className="md:space-x-4 px-6 lg:px-0 w-full md:space-y-4 text-center z-20 absolute top-[45%] left-1/2 text-white -translate-x-1/2 -translate-y-1/2">
          ...
          <Link to='/register'>
            <button className="bg-green-500 btn-sm md:btn-md md:text-xl font-semibold btn text-white border-none hover:bg-green-600 px-12">Join As Donors</button>
          </Link>
          <div className="my-3 md:hidden"></div>
          <Link to='/search'>
            <button className="bg-[#FF204E] btn-sm md:btn-md md:text-xl font-semibold btn text-white border-none hover:bg-red-600 px-12">Search Donors</button>
          </Link>
