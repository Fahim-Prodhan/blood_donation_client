                        ...
                        <div key={r._id} className="card  bg-base-100 shadow-xl">
                            <div className="card-body">
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    <p><span className='font-bold'>Recipient:</span> {r?.recipientName}</p>
                                    <p className='col-span-2'><span className='font-bold'>Address:</span> {r?.address}, {r?.upazila}, {r?.district}</p>
